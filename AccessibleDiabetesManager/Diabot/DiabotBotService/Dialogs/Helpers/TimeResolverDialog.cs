...
namespace Diabot.Dialogs.Helpers
{
    ...
    {
        private const string PromptMsgText = "When would you like to log the carb/schedule the meal?";
        private const string RepromptMsgText = "I'm sorry, to log your carb/schedule your meal, please enter a full date.";

        public TimeResolverDialog(string id = null)
